USE [{basename}]
GO
BACKUP DATABASE [{basename}] TO DISK = N'{backuppath}' WITH NOFORMAT, NOINIT,  NAME = N'{backupname}', SKIP, REWIND, NOUNLOAD, NO_COMPRESSION,  STATS = 10
GO
DBCC CHECKDB(N'{basename}')
GO
